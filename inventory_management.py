import json #Library for file Handling using JSON files
import os #Library to interact with OS, in this case to clear screen 
import atexit # Library for handling force and unexpected exit
...
class Inventory:  #Inventory Class with all the Methods
    ...
    def modify_product(self): #Method to update product_price and product_quantity
        ...
        if prod:
            print("\nProduct Name : ", prod.get_product_name())
            ...
            while 1: #Loop to take the value of new price with the proper validation
                ...
                if product_price == "":
                    product_price = prod.get_product_price()
                    break
                try:
                    price = float(product_price)
                    if price <= 0:
            ...
            while 1: #Loop to take the value of new quantity with the proper validation
                ...
                if product_quantity == "":
                    product_quantity = prod.get_product_quantity()
                    break
                if not (product_quantity.isdigit()):
                    print("Please enter a positive Integer value")
                else:
            ...
            print("\nPlease confirm the Product with Updated Details")
            print("\nProduct ID : " , (prod.get_product_id()))
            print("Product Name : " , (prod.get_product_name()))
            print("Product Price : " , (product_price))
            print("Product Quantity : " , (product_quantity))
...
def menu():
    ...
    atexit.register(inventory.save_json, "products.json") #save json file in case of unexpected or force exit of the program
    while True: #while loop for menu system
        os.system('cls' if os.name == 'nt' else 'clear') #Clear Screen when the main menu opens again
        print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        print("              ########################################  ")
